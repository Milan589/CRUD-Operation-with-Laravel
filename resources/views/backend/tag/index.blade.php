    ...
    <section class="content">
        ...
        <div class="card">
            <div class="card-header">
                <h3 class="card-title"> Tag Trash List 
                <a href="{{route('backend.tag.create')}}" @class("btn btn-info")" >Create</a>
                <a href="{{route('backend.tag.trash')}}" @class("btn btn-danger")" >Trash</a>
            </h3>
                    ...
                    <tbody>
                        @foreach ($data['records'] as $record )
                            <tr>
                                ...
                                <td>
                                    <a href="{{route('backend.tag.show', $record->id)}}" class="btn btn-primary">View</a>
